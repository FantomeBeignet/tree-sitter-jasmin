...
Definition wf_vars vars status :=
  match status with
  | Borrowed i => wf_vars_interval vars i
  | _ => True
  end.

Definition wfr_VARS vars rv :=
  forall r x, wf_vars vars (get_var_status rv r x).
